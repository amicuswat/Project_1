public class CheckWin {
    public boolean gain(int[][] igra , int krest) {  // Метод надо поменять но я пока не знаю как
        ...
        //int krest = 1; // эта переменная должна передаваться классу здесь вставил для тестирования
        ...
        for (int d=0; d<3; d++){
            if (horizontal[d]==3||vertical[d]==3||diagonal[d]==3 ){
                return true; // Здесь на самом деле должен быть возврадт True
            }
        }
      return false;
    }
